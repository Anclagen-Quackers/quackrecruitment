    ...
    <>
      <main className="flex flex-col">
        ...
        <Section bgColor="bg-gray-50">
          <h2>Our Policies</h2>
          <p>
            At Quack Group Ltd, we take privacy and data protection seriously. We are committed to ensuring the protection and proper use of your data. Below are our policies. Click on each to learn
            more.
          </p>
