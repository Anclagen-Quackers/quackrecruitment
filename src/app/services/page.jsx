      ...
      <main className="flex flex-col">
        ...
        <Section bgColor="bg-zinc-200">
          <FadeInFreeTextSection title="Prospective Clients" imageSrc="/images/pexels-yan-krukau-8867482.jpg" imageAlt="Description" reverse={true}>
            <p className="mt-4 text-lg leading-6">
              Our client list makes for eclectic reading, from major high street names, well managed local operations, to recruitment agencies who are among the top 4 largest in Europe, supporting
              them on second tiered projects on a national basis.
            </p>
            <p className="mt-4 text-lg leading-6">
