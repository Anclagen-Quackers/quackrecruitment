...
export const validationSchema = Yup.object({
  ...
  location: Yup.string().oneOf(["Walsall", "Birmingham", "Northampton", "Luton"], "Please select a location").required("Location is required"),
  traineeType: Yup.string().oneOf(["Company", "Individual", "Training Provider"], "Please select a training type").required("Training type selection is required"),
