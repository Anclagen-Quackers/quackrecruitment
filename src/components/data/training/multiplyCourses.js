export const multiplyCourses = [
    ...
    content: [
      {
        ...
        unitDescription: "Adding and subtracting basic numbers as you would in a work environment.",
      },
      {
        unitTitle: "Multiplication and Division (squared numbers)",
        unitDescription: "Multiplying basic numbers as you would in a work environment.",
      },
      {
        unitTitle: "Percentages and Fractions",
        unitDescription: "Working out percentages and fractions of basic numbers as you would in a work environment.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        unitTitle: "Adding and Subtracting",
        unitDescription: "Adding and subtracting basic numbers as you would in an everyday life environment.",
      },
      {
        unitTitle: "Multiplication and Division (squared numbers)",
        unitDescription: "Multiplying basic numbers as you would in an everyday life environment.",
      },
      {
        unitTitle: "Percentages and Fractions",
        unitDescription: "Working out percentages and fractions of basic numbers as you would in an everyday life environment.",
      },
    ],
    qualifiedTutorRequired: "Yes",
    accredited: "No",
    ...
    content: [
      {
        ...
        unitDescription: "Learners are expected to be able to count in steps of various sizes, including negative numbers; read, write, and understand positive whole numbers to one million.",
      },
      {
        unitTitle: "Use of common measures, shape, and space",
        unitDescription: "Learners are expected to be able to work out simple relationships between common units of measurement.",
      },
      {
        unitTitle: "Handle information and data",
        unitDescription: "Learners are expected to be able to select, construct, and interpret a range of statistical diagrams.",
      },
      {
        unitTitle: "Solving mathematical problems and decision making",
        unitDescription: "Learners at Level 1 are expected to be able to use the knowledge and skills listed above to solve straightforward problems.",
      },
    ],
    level: "1",
