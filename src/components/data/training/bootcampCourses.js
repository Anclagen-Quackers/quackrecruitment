export const bootcampCourses = {
  retrofitWmca: {
    ...
    cardDescription:
      "A funded retrofit bootcamp focused on energy efficiency, practical construction knowledge, and employability support.",
    cardHighlights: [
    ...
    hero: {
      ...
      heading: "Start a Career in Retrofit and Green Construction",
      intro: [
        ...
        "This intensive programme prepares individuals for careers in the rapidly growing retrofit and energy efficiency sector, supporting the UK’s transition to Net Zero.",
        "Retrofit focuses on improving the energy efficiency of existing homes and buildings. As demand for energy-efficient housing increases, the need for skilled retrofit professionals continues to grow.",
        "Our Skills Bootcamp provides learners with the knowledge, practical understanding and career support required to begin working in retrofit and sustainable construction.",
      ],
    },
    overview: {
      course: "Pathway to Retrofit Excellence",
    ...
    progressionIntro: "Learners who have completed our programmes have progressed into roles with:",
    progressionItems: [
  ...
  retrofitEcw: {
    ...
    hero: {
      eyebrow: "Skills Bootcamp",
      heading: "Retrofit and Green Construction Skills Training",
      intro: [
        ...
        "This programme equips learners with the skills needed to work in the growing retrofit and sustainable construction sector, supporting the region’s transition to a low-carbon economy.",
      ],
    },
    overview: {
      course: "Pathway to Retrofit Excellence",
    ...
    learningPoints: [
      ...
      "Domestic retrofit standards including PAS 2035",
      "Construction health and safety",
      "Retrofit insulation systems and materials",
      "Installation methods for energy efficiency measures",
      "Ventilation and building services",
      "Retrofit compliance and assessment processes",
    ],
