...
const logos = [
  ...
  {
    src: "/footer/ETF_Cyan_Digital_Logo.jpg",
    alt: "Education & Training Foundation logo",
    link: "https://www.et-foundation.co.uk/",
  },
  {
    src: "/footer/Department_for_Work_and_Pensions_logo.svg.png",
    alt: "Department for Work & Pensions",
    link: "https://www.gov.uk/government/organisations/department-for-work-pensions",
  },
  { src: "/footer/shaw_trust.png", alt: "Shaw Trust logo", link: "https://www.shawtrust.org.uk/" },
  {
    src: "/footer/West_Midlands_Combined_Authority_logo.svg.png",
    alt: "West Midlands Combine Authority logo",
    link: "https://www.wmca.org.uk/",
  },
  {
    src: "/footer/Approved-Training-Organisation-Status.jpg",
    alt: "CITB Approved Training Organisation Status",
  ...
  { src: "/footer/skillsbootcamp.jpg", alt: "Skills Bootcamps Logo" },
      ...
      >
        {[...logos, ...logos].map((logo, index) => (
          <img
            ...
            src={logo.src}
            alt={logo.alt}
            className="h-24 inline-block mx-2 bg-white p-1"
          />
        ))}
      </animated.div>
